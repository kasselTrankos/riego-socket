...
const notifyEnd = () => {console.log('hemos terminado, y no es normal o si?'); job.stop();};
...
const throwDateCron =  dates => index => {
  ...
  console.log('made riego at: ',  dates[index].date);
